...
conf_svm_trn = table(trn$correct, pred_svm_trn)
pred_svm_vld = predict(m_svm, newdata=vld)
conf_svm_vld = table(vld$correct[as.numeric(names(pred_svm_vld))], pred_svm_vld)

conf_svm_trn / rowSums(conf_svm_trn)
conf_svm_vld / rowSums(conf_svm_vld)
conf_svm_trn / colSums(conf_svm_trn)
conf_svm_vld / colSums(conf_svm_vld)
...
conf_nn_trn = table(trn$correct, pred_nn_trn)
pred_nn_vld = predict(m_nn, type='class', newdata=vld)
conf_nn_vld = table(vld$correct, pred_nn_vld)

conf_nn_trn / rowSums(conf_nn_trn)
conf_nn_vld / rowSums(conf_nn_vld)
conf_nn_trn / colSums(conf_nn_trn)
conf_nn_vld / colSums(conf_nn_vld)
